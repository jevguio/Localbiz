    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg">
            <div class="flex justify-between items-center">
                <h2 class="mt-3 text-xl font-bold text-gray-900 sm:text-2xl">Location Management</h2>
            ...
            <div class="relative overflow-x-auto mt-10 bg-white p-4 rounded-lg">
                    ...
                    <tbody id="product-table-body">
                        @foreach ($locations as $location)
                            <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <button data-modal-target="editModal{{ $location->id }}"
                                        class="font-medium text-blue-600 hover:underline" type="button">
                                        Edit
                                    </button>
                                    <button data-modal-target="deleteModal{{ $location->id }}"
                            ...
                            <div id="editModal{{ $location->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow-sm">
                                        <div
                                            ...
                                            <button type="button"
                                                ...
                                                data-modal-toggle="editModal{{ $location->id }}">
                                                <i class='bx bx-x text-gray-500 text-2xl'></i>
                                            </button>
                                        </div>
                                        <div class="grid gap-4 mb-4 p-4">
                                            <form action="{{ route('seller.locations.update', $location->id) }}"
                            ...
                            <div id="deleteModal{{ $location->id }}" tabindex="-1" aria-hidden="true"
                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-screen max-h-full bg-black bg-opacity-50">
                                <div class="relative p-4 w-full max-w-5xl max-h-full mx-auto">
                                    <div class="relative bg-white rounded-lg shadow-sm">
                                        <div
                                            ...
                                            <button type="button"
                                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                                data-modal-toggle="deleteModal{{ $location->id }}">
                                                <i class='bx bx-x text-gray-500 text-2xl'></i>
                                            </button>
                                        </div>
                                        <div class="grid gap-4 mb-4 p-4">
                                            <form action="{{ route('seller.locations.destroy', $location->id) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('DELETE')
                ...
                <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4"
                    ...
                    <span
                        ...
                        <span
                            class="font-semibold text-gray-900">{{ $locations->firstItem() }}-{{ $locations->lastItem() }}</span>
                        of <span class="font-semibold text-gray-900">{{ $locations->total() }}</span></span>
                ...
                <div id="addModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-5xl max-h-full mx-auto">
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div class="grid gap-4 mb-4 p-4">
                                <form action="{{ route('seller.locations.store') }}" method="POST"
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <input type="text" name="name" id="name"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                                placeholder="Type location name" value="{{ old('name') }}">
                                        </div>
                                    </div>
                                    <hr class="my-4">
                                    <div class="flex justify-end gap-2">
