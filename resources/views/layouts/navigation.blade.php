    ...
    <div class="overflow-auto py-6 h-full mt-4">
        <ul class="space-y-1">
                ...
                <li>
                    <div class="group">
                        <a href="{{ route('customer.order-history') }}"
                            class="text-black-800 text-base flex items-center group-hover:text-orange-900 transition-all">
                            <i class='bx bxs-wallet text-3xl mr-4 text-gray-400 group-hover:text-orange-900'></i>
                ...
                <li>
                    <div class="group">
                        <a href="{{ route('seller.dashboard') }}"
                            class="text-black-800 text-base flex items-center group-hover:text-orange-900 transition-all">
                            <i class='bx bxs-dashboard text-3xl mr-4 text-gray-400 group-hover:text-orange-900'></i>
                            <span>Dashboard</span>
                        </a>
                    </div>
                </li>
                ...
                <li>
                    <div class="group">
                        <a href="{{ route('government.approval') }}"
                            class="text-black-800 text-base flex items-center group-hover:text-orange-900 transition-all">
                            <i class='bx bxs-user-check text-3xl mr-4 text-gray-400 group-hover:text-orange-900'></i>
                            <span>Accounts</span>
                        </a>
                    </div>
                </li>
            ...
            @if (Auth::user()->role == 'DeliveryRider')
                ...
                <li>
                    <div class="group">
                        <a href="{{ route('rider.history.order') }}?status=delivered"
                            class="text-black-800 text-base flex items-center group-hover:text-orange-900 transition-all">
                            <i class='bx bxs-package text-3xl mr-4 text-gray-400 group-hover:text-orange-900'></i>
                            <span>Order History</span>
                        </a>
            ...
            <li>
                <div class="group">
                    <a href="{{ route('profile.edit') }}"
                        class="text-black-800 text-base flex items-center hover:text-orange-900 transition-all">
                        @if (Auth::user()->avatar)
            ...
            <li>
                <div class="group">
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <button type="submit"
                            class="text-black-800 text-base flex items-center hover:text-orange-900 transition-all">
                            <i class='bx bxs-log-out text-3xl mr-4 text-gray-400 group-hover:text-orange-900'></i>
                            <span>Logout</span>
                        </button>
                    </form>
                </div>
