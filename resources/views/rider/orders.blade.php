                                        ...
                                        <form action="{{ route('rider.orders.update', $order->id) }}" method="POST"
                                            ...
                                            <div class="grid grid-cols-2 gap-4 mb-4 p-4">
                                                ...
                                                <div class="flex justify-end gap-2">
                                                    <button type="submit" name="payment_status" value="fully_paid"
                                                        class="btn btn-success bg-green-700 hover:bg-green-800 text-white inline-flex items-center focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                                        Fully Paid
                                                    </button>
                                                    <button type="submit"
